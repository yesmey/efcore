...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    ...
    public class CoreOptionsExtension : IDbContextOptionsExtension
    {
        ...
        private bool _concurrencyDetectionDisabled;
        ...
        protected CoreOptionsExtension([NotNull] CoreOptionsExtension copyFrom)
        {
            ...
            _concurrencyDetectionDisabled = copyFrom.ConcurrencyDetectionDisabled;
        ...
        ///     It is unusual to call this method directly. Instead use <see cref="DbContextOptionsBuilder" />.
        /// </summary>
        /// <param name="concurrencyDetectionDisabled"> The option to change. </param>
        /// <returns> A new instance with the option changed. </returns>
        public virtual CoreOptionsExtension WithConcurrencyDetectionDisabled(bool concurrencyDetectionDisabled)
        {
            var clone = Clone();

            clone._concurrencyDetectionDisabled = concurrencyDetectionDisabled;
        ...
        /// </summary>
        public virtual bool ConcurrencyDetectionDisabled
            => _concurrencyDetectionDisabled;
        ...
        private sealed class ExtensionInfo : DbContextOptionsExtensionInfo
        {
            ...
            public override string LogFragment
            {
                get
                {
                    if (_logFragment == null)
                    {
                        ...
                        if (Extension._concurrencyDetectionDisabled)
                        {
            ...
            public override void PopulateDebugInfo(IDictionary<string, string> debugInfo)
            {
                ...
                debugInfo["Core:" + nameof(DbContextOptionsBuilder.DisableConcurrencyDetection)] =
                    Extension._concurrencyDetectionDisabled.GetHashCode().ToString(CultureInfo.InvariantCulture);
            ...
            public override long GetServiceProviderHashCode()
            {
                if (_serviceProviderHash == null)
                {
                    ...
                    hashCode = (hashCode * 3) ^ Extension._concurrencyDetectionDisabled.GetHashCode();
